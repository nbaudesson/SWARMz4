...
This module implements a controller for drone 5 that:
1. Takes off to 10m altitude
2. Navigates to position x=130, y=260, z=-10
3. Stays at that position as a target for drone 0

Usage:
    ros2 run offboard_control_py offboard_control_client_5 --ros-args -r __ns:=/px4_5
"""
...
class DroneController(Node):
    """
    Controller for drone 5 that implements a simple target-waiting behavior.
