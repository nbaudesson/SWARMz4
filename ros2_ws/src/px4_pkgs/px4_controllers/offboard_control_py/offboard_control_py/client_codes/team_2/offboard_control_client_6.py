...
2. Navigates to position x=126, y=260, z=-10
...
class DroneController(Node):
    """
    Controller for drone 6 that implements a simple target-waiting behavior.
    ...
    def __init__(self):
        ...
        self.target_position = (126.0, 260.0, -10.0, 0.0)  # x, y, z, yaw
