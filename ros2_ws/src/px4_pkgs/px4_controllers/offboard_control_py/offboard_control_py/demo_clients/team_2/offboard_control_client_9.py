...
class DroneController(Node):
    """
    Controller for drone 9 that positions it at a specific location.
    ...
    def __init__(self):
        ...
        self.wait_duration = 300.0  # Wait at target for 5 minutes before considering mission complete
