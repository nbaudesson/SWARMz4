...
class boat_test(Node):
    ...
    def __init__(self):
        ...
        #Publishers for thruster control /flag_ship_1/left_propeller_cmd

        self.left_thruster_pub = self.create_publisher(Float64, f'/flag_ship_{self.team_id}/left_propeller_cmd', 10)
        self.right_thruster_pub = self.create_publisher(Float64, f'/flag_ship_{self.team_id}/right_propeller_cmd', 10)
    ...
    def get_result_callback(self, future):
        ...
        missile_request.robot_name = f"/flag_ship_{self.team_id}"
