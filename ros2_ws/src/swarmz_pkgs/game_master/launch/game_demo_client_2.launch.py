...
def create_team_nodes(context, *args, **kwargs):
    ...
    return [
        ...
        # Drone 6: Move to be chain-killed by drone 5
        Node(
            package='offboard_control_py',
        ...
        # Drone 7: Move to be chain-killed by drone 6
        Node(
            package='offboard_control_py',
        ...
        # Drone 8: Move to be chain-killed by drone 7
        Node(
            package='offboard_control_py',
        ...
        # Drone 9: Move to be chain-killed by drone 8
        Node(
            package='offboard_control_py',
