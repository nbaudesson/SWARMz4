...
swarmz_interfaces__srv__Missile_Request__init(swarmz_interfaces__srv__Missile_Request * msg)
{
  ...
  if (!rosidl_runtime_c__String__init(&msg->robot_name)) {
    swarmz_interfaces__srv__Missile_Request__fini(msg);
    return false;
  }
  return true;
}
...
swarmz_interfaces__srv__Missile_Request__create()
{
  ...
  swarmz_interfaces__srv__Missile_Request * msg = (swarmz_interfaces__srv__Missile_Request *)allocator.allocate(sizeof(swarmz_interfaces__srv__Missile_Request), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(swarmz_interfaces__srv__Missile_Request));
  bool success = swarmz_interfaces__srv__Missile_Request__init(msg);
  if (!success) {
...
swarmz_interfaces__srv__Missile_Request__Sequence__init(swarmz_interfaces__srv__Missile_Request__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  swarmz_interfaces__srv__Missile_Request * data = NULL;

  if (size) {
    data = (swarmz_interfaces__srv__Missile_Request *)allocator.zero_allocate(size, sizeof(swarmz_interfaces__srv__Missile_Request), allocator.state);
    if (!data) {
      return false;
    }
    ...
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = swarmz_interfaces__srv__Missile_Request__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      ...
      for (; i > 0; --i) {
        swarmz_interfaces__srv__Missile_Request__fini(&data[i - 1]);
      }
...
swarmz_interfaces__srv__Missile_Request__Sequence__fini(swarmz_interfaces__srv__Missile_Request__Sequence * array)
{
  ...
  if (array->data) {
    ...
    for (size_t i = 0; i < array->capacity; ++i) {
      swarmz_interfaces__srv__Missile_Request__fini(&array->data[i]);
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  swarmz_interfaces__srv__Missile_Request__Sequence * array = (swarmz_interfaces__srv__Missile_Request__Sequence *)allocator.allocate(sizeof(swarmz_interfaces__srv__Missile_Request__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = swarmz_interfaces__srv__Missile_Request__Sequence__init(array, size);
  if (!success) {
...
swarmz_interfaces__srv__Missile_Request__Sequence__destroy(swarmz_interfaces__srv__Missile_Request__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    swarmz_interfaces__srv__Missile_Request__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
swarmz_interfaces__srv__Missile_Request__Sequence__are_equal(const swarmz_interfaces__srv__Missile_Request__Sequence * lhs, const swarmz_interfaces__srv__Missile_Request__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!swarmz_interfaces__srv__Missile_Request__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  swarmz_interfaces__srv__Missile_Request__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(swarmz_interfaces__srv__Missile_Request);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    swarmz_interfaces__srv__Missile_Request * data =
      (swarmz_interfaces__srv__Missile_Request *)allocator.reallocate(
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!swarmz_interfaces__srv__Missile_Request__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          swarmz_interfaces__srv__Missile_Request__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  for (size_t i = 0; i < input->size; ++i) {
    if (!swarmz_interfaces__srv__Missile_Request__copy(
...
swarmz_interfaces__srv__Missile_Response__are_equal(const swarmz_interfaces__srv__Missile_Response * lhs, const swarmz_interfaces__srv__Missile_Response * rhs)
{
  ...
  // has_fired
  if (lhs->has_fired != rhs->has_fired) {
    return false;
  }
  // ammo
  if (lhs->ammo != rhs->ammo) {
    return false;
  }
  return true;
}
  ...
  swarmz_interfaces__srv__Missile_Response * output)
{
  ...
  // has_fired
  output->has_fired = input->has_fired;
  // ammo
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  swarmz_interfaces__srv__Missile_Response * msg = (swarmz_interfaces__srv__Missile_Response *)allocator.allocate(sizeof(swarmz_interfaces__srv__Missile_Response), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(swarmz_interfaces__srv__Missile_Response));
  bool success = swarmz_interfaces__srv__Missile_Response__init(msg);
  if (!success) {
    allocator.deallocate(msg, allocator.state);
    return NULL;
  }
...
swarmz_interfaces__srv__Missile_Response__destroy(swarmz_interfaces__srv__Missile_Response * msg)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (msg) {
    swarmz_interfaces__srv__Missile_Response__fini(msg);
  }
  allocator.deallocate(msg, allocator.state);
}
...
swarmz_interfaces__srv__Missile_Response__Sequence__init(swarmz_interfaces__srv__Missile_Response__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  swarmz_interfaces__srv__Missile_Response * data = NULL;

  if (size) {
    data = (swarmz_interfaces__srv__Missile_Response *)allocator.zero_allocate(size, sizeof(swarmz_interfaces__srv__Missile_Response), allocator.state);
    if (!data) {
      return false;
    }
    // initialize all array elements
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = swarmz_interfaces__srv__Missile_Response__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      // if initialization failed finalize the already initialized array elements
      for (; i > 0; --i) {
        swarmz_interfaces__srv__Missile_Response__fini(&data[i - 1]);
      }
      allocator.deallocate(data, allocator.state);
      return false;
    }
...
swarmz_interfaces__srv__Missile_Response__Sequence__fini(swarmz_interfaces__srv__Missile_Response__Sequence * array)
{
  ...
  if (array->data) {
    ...
    // finalize all array elements
    for (size_t i = 0; i < array->capacity; ++i) {
      swarmz_interfaces__srv__Missile_Response__fini(&array->data[i]);
    }
    allocator.deallocate(array->data, allocator.state);
    array->data = NULL;
    array->size = 0;
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  swarmz_interfaces__srv__Missile_Response__Sequence * array = (swarmz_interfaces__srv__Missile_Response__Sequence *)allocator.allocate(sizeof(swarmz_interfaces__srv__Missile_Response__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = swarmz_interfaces__srv__Missile_Response__Sequence__init(array, size);
  if (!success) {
    allocator.deallocate(array, allocator.state);
    return NULL;
  }
...
swarmz_interfaces__srv__Missile_Response__Sequence__destroy(swarmz_interfaces__srv__Missile_Response__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    swarmz_interfaces__srv__Missile_Response__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
swarmz_interfaces__srv__Missile_Response__Sequence__are_equal(const swarmz_interfaces__srv__Missile_Response__Sequence * lhs, const swarmz_interfaces__srv__Missile_Response__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!swarmz_interfaces__srv__Missile_Response__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  swarmz_interfaces__srv__Missile_Response__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(swarmz_interfaces__srv__Missile_Response);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    swarmz_interfaces__srv__Missile_Response * data =
      (swarmz_interfaces__srv__Missile_Response *)allocator.reallocate(
      output->data, allocation_size, allocator.state);
    if (!data) {
      return false;
    }
    ...
    output->data = data;
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!swarmz_interfaces__srv__Missile_Response__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          swarmz_interfaces__srv__Missile_Response__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  output->size = input->size;
  for (size_t i = 0; i < input->size; ++i) {
    if (!swarmz_interfaces__srv__Missile_Response__copy(
        &(input->data[i]), &(output->data[i])))
    {
      return false;
    }
