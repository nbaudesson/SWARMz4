    ...
    def __import_type_support__(cls):
        try:
            ...
            logger = logging.getLogger(
                'swarmz_interfaces.msg.Detections')
            logger.debug(
            ...
            from swarmz_interfaces.msg import Detection
...
class Detections(metaclass=Metaclass_Detections):
    ...
    _fields_and_field_types = {
        ...
        'detections': 'sequence<swarmz_interfaces/Detection>',
    }

    SLOT_TYPES = (
        rosidl_parser.definition.NamespacedType(['std_msgs', 'msg'], 'Header'),  # noqa: E501
        rosidl_parser.definition.UnboundedSequence(rosidl_parser.definition.NamespacedType(['swarmz_interfaces', 'msg'], 'Detection')),  # noqa: E501
    )
