...
def main():
    ...
    commands = (
        ...
        "cd "+node.px4+" && export PX4_HOME_LAT="+str(node.latitude)+" && export PX4_HOME_LON="+str(node.longitude)+" && export PX4_HOME_ALT="+str(node.altitude)+" && PX4_SYS_AUTOSTART=4001 PX4_GZ_MODEL_POSE='1.5,0' PX4_GZ_MODEL=x500 "+node.gui+" ./build/px4_sitl_default/bin/px4 -i 1",
        "cd "+node.px4+" && export PX4_HOME_LAT="+str(node.latitude)+" && export PX4_HOME_LON="+str(node.longitude)+" && export PX4_HOME_ALT="+str(node.altitude)+" && PX4_SYS_AUTOSTART=4001 PX4_GZ_MODEL_POSE='0.46,1.43' PX4_GZ_MODEL=x500 "+node.gui+" ./build/px4_sitl_default/bin/px4 -i 2",
        "cd "+node.px4+" && export PX4_HOME_LAT="+str(node.latitude)+" && export PX4_HOME_LON="+str(node.longitude)+" && export PX4_HOME_ALT="+str(node.altitude)+" && PX4_SYS_AUTOSTART=4001 PX4_GZ_MODEL_POSE='-1.22,0.88' PX4_GZ_MODEL=x500 "+node.gui+" ./build/px4_sitl_default/bin/px4 -i 3",
        "cd "+node.px4+" && export PX4_HOME_LAT="+str(node.latitude)+" && export PX4_HOME_LON="+str(node.longitude)+" && export PX4_HOME_ALT="+str(node.altitude)+" && PX4_SYS_AUTOSTART=4001 PX4_GZ_MODEL_POSE='-1.22,-0.88' PX4_GZ_MODEL=x500 "+node.gui+" ./build/px4_sitl_default/bin/px4 -i 4",
        "cd "+node.px4+" && export PX4_HOME_LAT="+str(node.latitude)+" && export PX4_HOME_LON="+str(node.longitude)+" && export PX4_HOME_ALT="+str(node.altitude)+" && PX4_SYS_AUTOSTART=4001 PX4_GZ_MODEL_POSE='0.46,-1.43' PX4_GZ_MODEL=x500 "+node.gui+" ./build/px4_sitl_default/bin/px4 -i 5",
