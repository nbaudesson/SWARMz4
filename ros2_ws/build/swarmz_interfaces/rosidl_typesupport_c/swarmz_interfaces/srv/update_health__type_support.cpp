...
static const _UpdateHealth_Request_type_support_symbol_names_t _UpdateHealth_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, swarmz_interfaces, srv, UpdateHealth_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, swarmz_interfaces, srv, UpdateHealth_Request)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, swarmz_interfaces, srv, UpdateHealth_Request)() {
  return &::swarmz_interfaces::srv::rosidl_typesupport_c::UpdateHealth_Request_message_type_support_handle;
}
...
static const _UpdateHealth_Response_type_support_symbol_names_t _UpdateHealth_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, swarmz_interfaces, srv, UpdateHealth_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, swarmz_interfaces, srv, UpdateHealth_Response)),
  }
};
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, swarmz_interfaces, srv, UpdateHealth_Response)() {
  return &::swarmz_interfaces::srv::rosidl_typesupport_c::UpdateHealth_Response_message_type_support_handle;
}
...
static const _UpdateHealth_type_support_symbol_names_t _UpdateHealth_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, swarmz_interfaces, srv, UpdateHealth)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, swarmz_interfaces, srv, UpdateHealth)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_c, swarmz_interfaces, srv, UpdateHealth)() {
  return &::swarmz_interfaces::srv::rosidl_typesupport_c::UpdateHealth_service_type_support_handle;
}
